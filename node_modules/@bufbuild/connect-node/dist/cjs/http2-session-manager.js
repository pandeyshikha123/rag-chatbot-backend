...
exports.verify = exports.Http2SessionManager = void 0;
    ...
    async gotoReady() {
        if (this.s.t == "ready") {
            if (this.s.isShuttingDown()) {
                ...
                this.setState(verify(this.s, this.options, this.authority, this.http2SessionOptions));
            }
        }
...
function verify(stateReady, options, authority, http2SessionOptions) {
    ...
    return {
        ...
        abort(reason) {
            var _a;
            (_a = stateReady.abort) === null || _a === void 0 ? void 0 : _a.call(stateReady, reason);
        },
    };
}
