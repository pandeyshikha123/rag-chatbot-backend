...
export declare function verify(stateReady: StateReady, options: Required<Http2SessionOptions>, authority: string, http2SessionOptions: http2.ClientSessionOptions | http2.SecureClientSessionOptions | undefined): StateVerifying;
